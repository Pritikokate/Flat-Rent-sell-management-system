...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO flat (title,content,ptype,bhk,bedroom,balcony,hall,bathroom,kitchen,floor,price,district,city,size,loc,feature,aimage1,aimage2,aimage3,aimage4,approval)
	VALUES('$title','$content','$ptype','$bhk','$bed','$balc','$hall','$bath','$kitc','$floor','$price','$district','$city','$asize','$loc','$feature','$aimage1','$aimage2','$aimage3','$aimage4','$temp')";
...
<head>
    ...
    <body>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid justify content evenly ">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<br>
												<div class="form-group row">
													<label  for="select1"class="col-lg-3 col-form-label">District</label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
											<p class="alert alert-Deafult">* Important Please Do Not Remove Below Content Only Change <b>Yes</b> Or <b>No</b> or Details and Do Not Add More Details</p>
