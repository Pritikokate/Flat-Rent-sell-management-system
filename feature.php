            ...
            <div class="container">
					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        ...
                        <tbody>
							...
							$uid=$_SESSION['uid'];
                            echo "$uid";
							$query=mysqli_query($con,"SELECT * FROM `myflat` WHERE uid=$uid");
								while($row=mysqli_fetch_array($query))
								{
							?>
                            <tr>
                                <td>
									<img src="HomeUploaded/<?php echo $row['18'];?>" alt="pimage">
                                    <div class="property-info d-table">
                                        <h5 class="text-secondary text-capitalize"><a href="detail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['18'];?></span>
                                ...
                                <td><a class="btn btn-info" href="submitflatupdate.php?pid=<?php echo $row['0'];?>">Update</a></td>
								<td><a class="btn btn-danger" href="submitflatdelete.php?pid=<?php echo $row['0'];?>">Delete</a></td>
                            </tr>
							<?php } ?>
