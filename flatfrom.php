...
if(isset($_POST['add']))
{
	...
	move_uploaded_file($temp_name,"HomeUploaded/$aimage");
	move_uploaded_file($temp_name1,"HomeUploaded/$aimage1");
	move_uploaded_file($temp_name2,"HomeUploaded/$aimage2");
	move_uploaded_file($temp_name3,"HomeUploaded/$aimage4");
	move_uploaded_file($temp_name5,"HomeUploaded/$fimage");
	move_uploaded_file($temp_name6,"HomeUploaded/$fimage1");
	move_uploaded_file($temp_name7,"HomeUploaded/$fimage2");
	move_uploaded_file($pdf_tmp_name,"HomeUploaded/$pdf_name");
	
	$sql="insert into myflat (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,district,city,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor,Document,Email)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$district','$city','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor', '$pdf_name','$Email')";
	...
	if($result)
		...
		{
			$error="<p class='alert alert-warning'>Flat Not Inserted Some Error</p>";
		}
}		
?>
<!DOCTYPE html>
...
<head>
    ...
    <body>
			...
			<?php include("navforloginuser.php"); ?>
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
												<label  for="select1"class="col-lg-3 col-form-label"> Select District</label>
												<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
											<p class="alert alert-dark">* Important Please Do Not Remove Below Content Only Change <b>Yes</b> Or <b>No</b> or Details and Do Not Add More Details</p>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Add Documents PDF</label><br>
												Required documents:<br>
													1.1. Sale deed.<br>
													1.2. Completion/Occupancy Certificate.<br>
													1.3. Building plan.<br>
													1.4. Encumbrance certificate.<br>
													1.5. Mutation certificate.<br>
													1.6. General Power of Attorney.<br>
													1.7. No Objection Certificate.<br>
													<div class="col-lg-9">
