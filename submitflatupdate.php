...
if(isset($_POST['add']))
{
	...
	move_uploaded_file($temp_name1,"images/$aimage1");
	move_uploaded_file($temp_name2,"images/$aimage2");
	move_uploaded_file($temp_name3,"images$aimage3");
	move_uploaded_file($temp_name4,"images/$aimage4");
	
	move_uploaded_file($temp_name5,"images/$fimage");
	move_uploaded_file($temp_name6,"images/$fimage1");
	move_uploaded_file($temp_name7,"images/$fimage2");
	
	
	$sql = "UPDATE myflat SET title= '{$title}', pcontent= '{$content}', type='{$ptype}', bhk='{$bhk}', stype='{$stype}',
	bedroom='{$bed}', bathroom='{$bath}', balcony='{$balc}', kitchen='{$kitc}', hall='{$hall}', floor='{$floor}', 
	size='{$asize}', price='{$price}', location='{$loc}', district='{$district}', city='{$city}', feature='{$feature}',
	...
	if($result == true)
	{
		$msg="<p class='alert alert-success'>your flat Updated</p>";
		header("Location:feature.php?msg=$msg");
	}
	else{
		$msg="<p class='alert alert-warning'>Your flat Not Updated</p>";
		header("Location:feature.php?msg=$msg");
	}
}						
?>
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Update Flat Details</h2>
                        </div>
					</div>
                    <div class="row p-5 bg-white">
                        <form method="post" enctype="multipart/form-data">
								...
								<?php
									...
									$pid=$_REQUEST['pid'];
									$query=mysqli_query($con,"select * from myflat where pid='$pid'");
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/<?php echo $row['18'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/<?php echo $row['20'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/<?php echo $row['22'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
