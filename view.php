...
<!--	Title
	=========================================================-->
<title>View flats to user</title>
</head>
<body>
    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Serched Flat</b></h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
							...
							{
								$district=$_REQUEST['select1'];
								$city=$_REQUEST['select2'];
                              //  $sql="select * from myflat  where  district='$district' and city='$city'";
							$sql="SELECT myflat.*, user.uname FROM myflat,user WHERE myflat.uid=user.uid and district='{$district}' and city='{$city}' and statusP=1";
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"><img src="HomeUploaded/<?php echo $row['18'];?>" alt="pimage" width="400px" height="400px">
                    ...
                    <div class="col-lg-4 justify content center">
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recently Added Flats</h4>
                            <ul class="property_list_widget">
							
								<?php 
								$query=mysqli_query($con,"SELECT * FROM myflat ORDER BY date DESC LIMIT 6");
